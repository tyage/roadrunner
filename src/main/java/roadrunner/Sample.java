...
import roadrunner.parser.Lexer;
...
public class Sample  {
    ...
    public Sample(URL url, Preferences options) throws IOException, SAXException {
        this.url = url;
        log.fine("Reading "+this.getURL());
        Reader source = new BufferedReader(new InputStreamReader(getURL().openStream()));
