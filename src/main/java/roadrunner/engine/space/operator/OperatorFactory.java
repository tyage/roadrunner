 ...
 *
 * Created on 14 aprile 2003, 16.52
...
abstract class OperatorFactory {
    protected MismatchPoint m;
    protected SearchSpace space;
    
    OperatorFactory(MismatchPoint m) {
        this.m = m;
        this.space = m.getSearchSpace();        
    }
    
    abstract public List createOperators();
